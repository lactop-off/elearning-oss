...
- [ ] **ホームのヒーロー刷新** — 価値提案・主要 CTA・アイコン/イラストで第一印象を強化
- [ ] **タイポグラフィ階層の統一** — ページ主見出し `<h1>` のサイズばらつき (text-3xl / 2xl / base) を 1 種に統一 (診断指摘事項)
- [ ] **loading.tsx / error.tsx / not-found.tsx の整備** — Skeleton・再試行 CTA・404 案内。データ取得を伴う全ルートに
