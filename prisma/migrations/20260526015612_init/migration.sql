...
-- CreateEnum
CREATE TYPE "LessonContentType" AS ENUM ('TEXT', 'VIDEO', 'EMBED');

-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('SINGLE_CHOICE', 'MULTI_CHOICE', 'TEXT');
...
-- CreateTable
CREATE TABLE "_AnswerChoices" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_AnswerChoices_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_AnswerChoices_B_index" ON "_AnswerChoices"("B");
...
-- AddForeignKey
ALTER TABLE "_AnswerChoices" ADD CONSTRAINT "_AnswerChoices_A_fkey" FOREIGN KEY ("A") REFERENCES "Answer"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AnswerChoices" ADD CONSTRAINT "_AnswerChoices_B_fkey" FOREIGN KEY ("B") REFERENCES "Choice"("id") ON DELETE CASCADE ON UPDATE CASCADE;
